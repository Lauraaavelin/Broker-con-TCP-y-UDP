...
#define BACKLOG 2 // máximo de conexiones pendientes en cola para hacer accept
...
int main() {
    ...
    resultado_listen = listen(socket_listen, BACKLOG); // activa la escucha y permite hasta dos conexiones pendientes en cola
